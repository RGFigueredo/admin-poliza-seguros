...
<html lang="en">
    <head>
        ...
        include INC_DIR.'/lista_corredores.php';
                                                ...
                                                <?php foreach ($rows as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-xs btn-info" title="Modificar">
                                                            ...
                                                            <button class="btn btn-xs btn-danger" title="Dar de baja" data-toggle="modal" data-target="#Quejas">
