...
$query = "  SELECT  cedula,
                    ...
                    estado,
                    corredor_cedula
            FROM    asegurado where cedula='$cedula'
         ";
    try{
                                                    ...
                                                    <div id="step-2">
                                                        ...
                                                        <table cellspacing="3" cellpadding="3" align="center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                    <input onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" type="text" id="cedula" name="corredor_cedula" value="<?php echo $row['corredor_cedula'];   ?>" class="txtBox" data-format="dddddddd"> </td>
