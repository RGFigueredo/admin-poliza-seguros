...
<head>
    ...
    <?php
        ...
        include INC_DIR.'/datos_beneficiario.php';
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-header"> Beneficiarios registrados </div>
                                        ...
                                        <?php foreach ($rows as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=eliminar&tipo=beneficiario&id=<?PHP echo $row['cedula']?>">
