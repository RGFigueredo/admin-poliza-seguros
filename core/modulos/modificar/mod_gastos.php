...
$query = "  SELECT codigo,
monto,
                    reembolso,asegurado_cedula,
                    estatus               
            
            FROM    gastos where codigo='$id'
         ";
    try{
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>Empresa</li>
                        <li class="active">Modificacion gastos</li>
                    </ul>
                    <!-- /.breadcrumb -->
                                ...
                                <tr>
                                    <td>
                                        <?php foreach ($rows as $row) {
                                                    ?>
                                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=modgastos&id=<?php echo $id?>" method="post">
                                                <!-- Tabs -->
                                                <div id="wizard" class="swMain">
                                                    <ul>
                                                        <li>
                                                            <a href="#step-1">
                                                                <label class="stepNumber">1</label> <span class="stepDesc">Gastos<br />
                   <small>Datos </small>
                </span> </a>
                                                        </li>
                                                        <!-- <li>
                   ...
                   <small>Datos de Contacto</small>
                                                    ...
                                                    <div id="step-1">
                                                        <h2 class="StepTitle">Paso 1: Datos Generales del gasto.</h2>
                                                        <table cellspacing="3" cellpadding="3" align="center">
                                                            <tr>
                                                                <td align="right">Codigo Factura:</td>
                                                                <td align="left">
                                                                    <input type='hidden' name="codigo" value="<?php echo $row['codigo'];?>">
                                                                    <input type="text" id="codigo" name="codigo" disabled value="<?php echo $row['codigo'];?>" > </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left">
                                                                        <select id="reembolso" name="reembolso" class="form-control selectpicker">
                                                                        <option>
