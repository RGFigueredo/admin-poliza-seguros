...
if (!defined('SRCP')) {
    ...
    if (!empty($_POST)) {
        ...
        $query = 'UPDATE gastos SET reembolso = :reembolso
                WHERE codigo = :gastos_codigo
                ';
        $query_params = array(           
        ...
        //AQUI TIENE QUE ACTUALIZAR GASTOS
        //SE DEBE CAMBIAR LA TABLA reembolso("Pendiente") a reembolso("Pagado");
