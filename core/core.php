...
case 'registroaseguradora' :
    if ($login_ok) { 
    include_once CORE_DIR.'/modulos/registroaseguradora.php';
        break;  
    } else {
            include_once CORE_DIR.'/modulos/login.php';
        }
  ...
  case 'registrocorredor' :
    if ($login_ok) {
include_once CORE_DIR.'/modulos/registrocorredor.php';
        break;  
    } else {
            include_once CORE_DIR.'/modulos/login.php';
        }
  ...
  case 'registroasegurado' :
    if ($login_ok) {
include_once CORE_DIR.'/modulos/registroasegurado.php';
        break;  
    } else {
            include_once CORE_DIR.'/modulos/login.php';
        }
  ...
  case 'registrobeneficiario' :
    if ($login_ok) {
include_once CORE_DIR.'/modulos/registrobeneficiario.php';
        break;  
    } else {
            include_once CORE_DIR.'/modulos/login.php';
        }
