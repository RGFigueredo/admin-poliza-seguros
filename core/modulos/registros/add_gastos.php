	...
	<title>Registro de gastos</title>
        ...
        $data = getDataBySession($_COOKIE['session'], $db);
            if (!empty($_POST)) {
                ...
                include_once INC_DIR.'/reg_gastos.php';
            }
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<table align="center" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=addgastos" method="POST">
											...
											<ul>
												<li>
													<a href="#step-1">
														...
														<span class="stepDesc">Gastos<br />
                   <small>Asegurado</small>
                </span>
													</a>
												</li>
												<!--<li>
                   ...
                   <small>Datos de Contacto</small>
											...
											<div id="step-1">
												<h2 class="StepTitle">Paso 1: Registro de gastos.</h2>
...
?>
                                                    ...
                                                    <tr>
														...
														<td align="left">
															<input type="text" id="monto" name="monto" value="" class="txtBox">
														</td>
													...
													<tr>
														<td align="right">Codigo de factura:</td>
														<td align="left">
															<input type="text" id="codigo" name="codigo" value="" class="txtBox">
														</td>
