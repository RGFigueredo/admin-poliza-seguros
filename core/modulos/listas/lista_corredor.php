                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-header"> Corredores registrados </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=modcorredor&cedula=<?PHP echo $row['cedula']?>">
