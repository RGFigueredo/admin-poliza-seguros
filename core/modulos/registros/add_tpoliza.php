...
<head>
    <title>Registro de tipo de Poliza</title>
    <?php
            if (!defined('SRCP')) {
        ...
        $data = getDataBySession($_COOKIE['session'], $db);
            if (!empty($_POST)) {
                ...
                include_once INC_DIR.'/reg_tpoliza.php';
            }
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>Empresa</li>
                        <li class="active">Registro de tipo de Poliza</li>
                    </ul>
                    <!-- /.breadcrumb -->
                                                ...
                                                <div id="step-1">
                                                    ...
                                                    <table cellspacing="3" cellpadding="3" align="center">
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <input type="text" id="codigo" name="codigo" value="" class="txtBox bfh-phone" data-format="TP-dddd"> </td>
                                    </td>
