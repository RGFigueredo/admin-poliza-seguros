...
if (!empty($_POST)) {
	...
	include_once INC_DIR.'/reg_servicio.php';
		...
		<div class="main-content-inner">
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li>Empresa</li>
					<li class="active">Registro de Servicio</li>
				</ul>
				<!-- /.breadcrumb -->
...
?>?do=addservicio" method="POST">
										<!-- Tabs -->
										<div id="wizard" class="swMain">
											<ul>
												<li>
													         <a href="#step-1">
                                                                <label class="stepNumber">1</label> <span class="stepDesc">Servicios<br />
                   <small>Datos </small>
                </span> </a>
                                                        </li>
                                                        <!-- <li>
                   ...
                   <small>Datos de Contacto</small>
                                                    ...
                                                    <div id="step-1">
                                                        <h2 class="StepTitle">Paso 1: Datos Generales del servicio.</h2>
                                                        <table cellspacing="3" cellpadding="3" align="center">
                                                         
                                                                  <?php  
include INC_DIR.'/datos_servicio.php';

$combobit="";

$combobit2="";

foreach ($rows_poliza as $row){
...
foreach ($rows_seguro as $row){

	$combobit2.="->Seleccione:";

	$combobit2.=" <option value='".$row['codigo']."'>".$row['codigo']."</option>";
	
}


// generamos un codigo unico que no este en la base de datos, porque el codigo es un varchar.

$query2 = "  
			SELECT FLOOR(10000 + RAND() * 89999) AS random_number
			FROM tiposeguro
			WHERE 'random_number' NOT IN (SELECT codigo FROM servicio)
			LIMIT 1
         ";
...
?>
								...
								<td align="left"><span id="msg_nombre"></span>&nbsp;</td>
									...
									<tr>
						<td align="right">Codigo de la poliza:</td>
						<td align="left">
								<select required id="cod_poliza" name="cod_poliza" >                                       
												<option value="">
													<?php echo $combobit;?>
											</option>
						...
						<td align="left"><span id="msg_cedula"></span>&nbsp;</td>
									...
									<tr>
						<td align="right">Codigo del seguro:</td>
						<td align="left">
								<select required id="cod_seguro" name="cod_seguro" >                                       
							<option value="">
							<?php echo $combobit2;?>
							</option>
