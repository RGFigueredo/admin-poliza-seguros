...
<head>
    <title>Listar Aseguradora </title>
    <?php
            if (!defined('SRCP')) {
            ...
            <div class="main-content-inner">
                <div class="breadcrumbs" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Lista de Aseguradora</li>
                    </ul>
                    <!-- /.breadcrumb -->
                                        ...
                                        <?php foreach ($rows as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=eliminar&tipo=aseguradora&id=<?PHP echo $row['rif']?>">
