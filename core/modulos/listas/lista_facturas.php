...
<head>
    ...
    <?php
        ...
        include INC_DIR.'/datos_facturas.php';
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-header"> Facturas </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($rows as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $row['montototal'];?>
                                                </td>
                                                <td>
                                                    <?php echo $row['montocancelado']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row['servicio_codigo']?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=eliminar&tipo=facturas2&id=<?PHP echo $row['codigo']?>">
                                                            <button class="btn btn-xs btn-danger" title="No Cancelada"> <i class="ace-icon fa fa-times bigger-120"></i> </button>
                                                        </a>
                                                    </div>
                                                    
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>?do=eliminar&tipo=facturas&id=<?PHP echo $row['codigo']?>">
                                                            <button class="btn btn-xs btn-success" title="Cancelada"> <i class="ace-icon fa fa-check bigger-120"></i> </button>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <?php include_once STATIC_DIR.'/footer.php';?>
            ...
            <script type="text/javascript">
                jQuery(function($) {
                    ...
                    $(colvis.button()).prependTo('.tableTools-container .btn-group').attr('title', 'Mostrar/Ocultar columnas').tooltip({
                        container: 'body'
                    });
                    //and make the list, buttons and checkboxed Ace-like
                    $(colvis.dom.collection).addClass('dropdown-menu dropdown-light dropdown-caret dropdown-caret-right').find('li').wrapInner('<a href="javascript:void(0)" />') //'A' tag is required for better styling
